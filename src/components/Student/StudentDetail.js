...
const StudentDetail = () => {
    ...
    const [user, setUser, userLoading, setUserLoading] = useUser(id, 'student', status);
    const handleSearch = e => {
        e.preventDefault();
        setUser({});//Clear previous search user
        setUserLoading(true);//load till fetch data
        setId(`st-${searchId.current.value.toLowerCase()}`);
        setStatus(!status);
    }
    return (
        <div className="app">
                    ...
                    <div className="container-xl">
                        <div className="row g-3 mb-4 align-items-center justify-content-between shadow-sm p-3 rounded">
                            <div className="col-auto">
                                <h1 className="app-page-title mb-0">Search for student</h1>
                            </div>
                            <div className="col-auto">
                                                ...
                                                <div className="item border-bottom py-3">
                                                    <div className="row justify-content-between align-items-center">
                                                        <div className="col-auto">
                                                            ...
                                                            <div className="item-data">{user?.university}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="item border-bottom py-3">
                                                    <div className="row justify-content-between align-items-center">
                                                        <div className="col-auto">
                                                            ...
                                                            <div className="item-data">{user?.department}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="item border-bottom py-3">
                                                    <div className="row justify-content-between align-items-center">
                                                        <div className="col-auto">
                                                            ...
                                                            <div className="item-data">{user?.dob}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="item border-bottom py-3">
